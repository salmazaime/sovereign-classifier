...
class InviteUserRequest(BaseModel):
    ...
    email: str
    password: str
    role: str  # "admin" | "compliance_reviewer" | "compliance_officer" | "viewer"
...
class CompanyProfileResponse(BaseModel):
    ...
    sector: str
    is_oiv: bool
    oiv_sector: Optional[str] = None
    qualified_provider_required: bool


class CompanyUpdateRequest(BaseModel):
    sector: Optional[str] = None
    is_oiv: Optional[bool] = None
    oiv_sector: Optional[str] = None
    qualified_provider_required: Optional[bool] = None
